...
while ($homePageEvents->have_posts()) {
    ...
    get_template_part('template-parts/content', 'event'); // not the .php just the slug
}
...
<?php
  $slideContent = new WP_Query(array(
    'post_type' => 'slide'
  ));
while ($slideContent->have_posts()) {
    $slideContent->the_post();
    ?>
    ...
    <div class="hero-slider__slide" style="background-image: url(<?php echo get_the_post_thumbnail_url() ?>)">
      <div class="hero-slider__interior container">
        <div class="hero-slider__overlay">
          ...
          <p class="t-center"><?php the_content() ?>
          <!-- <?php echo get_post_meta( get_the_ID(), 'slide_subtitle', true ) ?> -->
          </p>
