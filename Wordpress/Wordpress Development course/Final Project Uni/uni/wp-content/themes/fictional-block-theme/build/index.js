...
class MyNotes {
  ...
  deleteNote(e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      //doesn't work with .dataset['id']
      type: 'DELETE',
      // if the request is sucessful
      success: response => {
        thisNote.slideUp();
        if (response.userNoteCount < 5) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()('.not-limit-message').removeClass('active');
        }
      },
      error: response => {
        console.log("Sorry");
  ...
  makeNoteReadOnly(thisNote) {
    ...
    thisNote.find('.note-title-field, .note-body-field').attr("readonly", "readonly") //name and value
...
class Search {
  ...
  constructor() {
    ...
    this.openButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".js-search-trigger"); // the icon button
  ...
  addSearchHTML() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('footer').after(`
