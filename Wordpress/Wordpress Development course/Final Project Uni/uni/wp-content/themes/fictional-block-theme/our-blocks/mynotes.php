...
if (!is_user_logged_in()) {
    ...
    // tell wordpress stop spinning its gears when redirecting and don't use server resources
    exit;
}

// We need the file for the url based information
while (have_posts()) {
    the_post(); // readies the post data
    // we make the banner dynamic
    pageBanner();
    ?>
<!--  create another query for what we want -->
    <div class="container container--narrow page-section">
        <div class="create-note">
            <h2 class="headline headline--medium">Create New Note</h2>
            <input class="new-note-title" type="text" placeholder="Title">
            <textarea class="new-note-body" placeholder="Your note here..." ></textarea>
            <span class="submit-note">Crate Note</span>
